...
There is actually no $F_K$ is Neal's original formulation. However, in most
...
Note that the logarithm actually returns the logarithm of the importance weight
